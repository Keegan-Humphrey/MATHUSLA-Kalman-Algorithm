...
class Plotter:
    ...
    def IP_consistency_angles(self):
        ...
        _Title = 'Angular details of IP consistecny {}'.format(self.sample)
...
def main():
    ...
    permutation = [0,1,2,4,14,3,15,18,19,9,13,11,5,6,7,8,10,12,16,17] # order in which the cuts are performed

...
public:
	...
	vertex_seed_c_b() {}
	vertex_seed_c_b(physics::track *track1, physics::track *track2) : tracks(track1, track2)
	{
	}
...
//	std::vector<vertex_seed_c_b> seeds;
//	std::vector<vertex_seed_c_b> seeds_k;
	std::vector<vertex_seed_c_b> seeds_k_m;

...
in_names="/home/keeganh/projects/rrg-mdiamond/keeganh/job_test/W_sample_dir/Parallel/analysis_names_6sim_7tracker_1e5.txt"
...
do
	...
	echo "job: $(($MAX_SERIES*$SLURM_ARRAY_TASK_ID+$n))"
